<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <a class="dropdown-item" href="../login/cerrar.php">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="../index/dirigir.php">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../gestion/evaluar.php">Evaluar</a></li>
        </ul>
        </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="../informe/procesos.php">Matriz</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#residuos" aria-expanded="false" aria-controls="residuos">
              <i class="icon-columns menu-icon"></i>
              <span class="menu-title">Residuos</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="residuos">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="../informe/infor.php">Gestor</a></li>
              </ul>
            </div>
          </li>
      </nav>